...
public class SavePieChartTask {
    ...
    public SavePieChartTask(String phoneNumber, View pieChartView,
                            Context context){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Constants.URL_GET_PIE_CHART_DATA,
                response -> {
                    ...
                    try{
                        ...
                        db.delete("PIECHARTFEED",null,null);
                        for (int i=0; i<jsonArray.length();i++){
                            ...
                            if(!objects.getBoolean("error")){
                                ...
                                helper.insertPieChartFeed(db,item[i],entry[i]);
                            }
                        }
                        db.close();
                        helper.close();
